...
\begin{align}
    ...
    \underbrace{\color{#6BFFB8}{\frac{\bigtriangleup E_{\frac{\alpha}{\epsilon},t}}{E_{\frac{\alpha}{\epsilon},t}}}}_\text{Tasa de depreciación del tipo de cambio nominal} = \underbrace{\color{#6BFFB8}{\pi_{\alpha,t} - \pi_{\epsilon,t} }}_\text{Diferencial de Inflación}
